...
tasks = [
    (
        "Single-QA",
        41.66,
        [40.77, 40.82, 35.65, 32.34, 29.83, 27.85, 25.56, 23.07, 19.56, 18.89],
    ),
    (
        "Multi-QA",
        43.47,
        [44.26, 44.28, 40.73, 37.85, 34.11, 32.29, 28.09, 26.12, 24.44, 23.20],
    ),
    (
        "Summarization",
        24.41,
        [24.66, 24.31, 24.24, 24.30, 23.72, 23.68, 23.44, 23.37, 22.92, 22.82],
    ),
    (
        "Few-Shot",
        62.50,
        [63.59, 64.27, 65.53, 66.15, 65.59, 65.15, 65.42, 64.16, 58.62, 56.11],
    ),
...
for ax, (task, full, sparse) in zip(axes, tasks):
    ...
    ax.plot(top_p_sparse, delta_perf, marker="o", markersize=3)

    # Full baseline → y = 0
    ax.axhline(y=0.0, linestyle="--", linewidth=1.6, color="black")
