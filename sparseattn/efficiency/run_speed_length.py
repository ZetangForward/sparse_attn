...
def load_model(model_path, is_sparse):
    ...
    if is_sparse:
        ...
        if "PawLlama" in arch_name:
            from sparseattn.efficiency.model.modeling_flash_llama_streaming import (
                PawLlamaForCausalLM,
                PawLlamaConfig,
            )
        ...
        if "PawLlama" in arch_name:
            from sparseattn.efficiency.model.modeling_flash_llama_full1 import (
                PawLlamaForCausalLM,
                PawLlamaConfig,
            )
...
def main():
    ...
    target_lengths_k = [8, 16, 32, 64, 128, 256]
