    ...
    def _load_optimizer_and_scheduler(self, checkpoint):
        ...
        if checkpoint is not None and self.args.streaming_dataset:
            try:
                ...
                logger.warning(f"Failed to load streaming dataset state from {checkpoint}")
            ...
            logger.warning(f"Resume streaming dataset state from {checkpoint}: {dataset_state_dict}")
